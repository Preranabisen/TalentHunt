...
class InstitutesSignup extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: '',
  ...
  handleSubmit = () => {
    if (this.state.username == 'admin@gmail.com' && this.state.password == '1234') {
        this.props.navigation.navigate('InstitutesForm');
    } else {
    ...
    return (
      <View>
        ...
        <ScrollView style={styles.HomeView}>
          <View>
            <Text style={styles.RegistrationTitle}>Institutes Registraion</Text>
...
export default InstitutesSignup;
